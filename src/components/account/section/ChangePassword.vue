<template>
  <div class="user-group" v-if="isShow">
    ...
    <form>
      ...
      <label for="mot_de_passe">Mot de passe actuelle</label>
      <input v-model="password" type="password" name="mot_de_passe" placeholder="Entrez votre mot de passe">

      <label for="mot_de_passe">Nouveau Mot de passe</label>
      <input v-model="newPassword" type="password" name="mot_de_passe"
             placeholder="Entrez le nouveau mot de passe">

      <label for="mot_de_passe">Confirmation Nouveau Mot de passe</label>
      <input v-model="repeatNewPassword" type="password" name="mot_de_passe"
...
export default defineComponent({
  components: {
    LoadingOverlay,
    IonIcon, ErrorModal, ValidateModal, SuccessModal
  },
  data(){
    return {
  ...
  methods: {
    ...
    change(){
      this.loading = true;
      axios.post('https://delmoo.fr:5000/change/password', {
