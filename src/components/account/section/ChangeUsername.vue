<template>
  <div class="user-group" v-if="isShow">
    ...
    <form>
      ...
      <label for="mot_de_passe">Nom d'utilisateur</label>
      <input v-model="username" type="text" name="mot_de_passe" placeholder="Nom d'utilisateur">
...
export default defineComponent({
  ...
  methods: {
    ...
    change(){
      this.loading = true;
      axios.post('https://delmoo.fr:5000/change/username', {
